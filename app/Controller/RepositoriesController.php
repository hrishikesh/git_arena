...
class RepositoriesController extends AppController {
    ...
    public function activity_feeds() {

        $this->layout = 'ajax';

        //fetch the responses array based on no. of responses selected
        $repoName  = $this->params->query['repoName'];
        $ownerName = $this->params->query['ownerName'];

        //        $userName = $this->Auth->user('name');

        $commits = $this->GitHubApi->getCommitsForRepo($ownerName, $repoName);
    ...
    public function contributors_list() {
        ...
        $contributors = $this->GitHubApi->getRepoContributors($ownerName, $repoName);
